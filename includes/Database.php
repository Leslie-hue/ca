...
class Database {
    ...
    private function insertDefaultSiteContent() {
        $defaultContent = [
            ...
            ['about', 'content', 'Notre cabinet d\'avocats se distingue par son approche personnalisée et son expertise reconnue dans de nombreux domaines du droit. Nous mettons notre savoir-faire au service de nos clients pour leur offrir les meilleures solutions juridiques.'],
            ['about', 'additional_content', 'Chaque dossier est traité avec la plus grande attention, dans le respect de la déontologie et avec un souci constant de l\'efficacité et de la transparence.'],
            ['values', 'title', 'Nos Valeurs'],
            ['values', 'subtitle', 'Les principes qui guident notre action au quotidien'],
            ['values', 'integrity_title', 'Intégrité'],
            ['values', 'integrity_description', 'Nous agissons avec honnêteté et transparence dans toutes nos relations professionnelles.'],
            ['values', 'excellence_title', 'Excellence'],
            ['values', 'excellence_description', 'Nous visons l\'excellence dans chaque dossier et nous formons continuellement.'],
            ['values', 'commitment_title', 'Engagement'],
            ['values', 'commitment_description', 'Nous nous engageons pleinement pour défendre les intérêts de nos clients.'],
            ['success', 'title', 'Taux de Réussite'],
            ['success', 'subtitle', 'Des résultats qui parlent d\'eux-mêmes'],
            ['success', 'success_rate', '95%'],
            ['success', 'clients_count', '500+'],
            ['success', 'experience_years', '20+'],
            ['success', 'cases_won', '1000+'],
            ['services', 'title', 'Nos services'],
            ['team', 'title', 'Notre équipe'],
            ['mission', 'title', 'Notre Mission'],
            ['mission', 'description', 'Notre mission est de fournir des services juridiques d\'excellence, en alliant expertise technique et approche humaine. Nous nous engageons à défendre vos intérêts avec détermination et à vous accompagner dans toutes vos démarches juridiques avec professionnalisme et éthique.'],
            ['mission', 'commitment_title', 'Engagement'],
            ['mission', 'commitment_description', 'Défendre vos droits avec détermination'],
            ['mission', 'proximity_title', 'Proximité'],
            ['mission', 'proximity_description', 'Une relation de confiance et d\'écoute'],
            ['mission', 'innovation_title', 'Innovation'],
            ['mission', 'innovation_description', 'Des solutions juridiques modernes'],
            ['contact', 'title', 'Contactez-nous'],
            ['contact', 'address', '123 Avenue de la Justice, 75001 Paris'],
            ['contact', 'phone', '+33 1 23 45 67 89'],
            ['contact', 'email', ADMIN_EMAIL],
            ['contact', 'hours', 'Lun-Ven: 9h-18h<br>Sam: 9h-12h'],
